package com.shcem.configCenter.factory;

import com.google.common.base.Preconditions;
import com.shcem.configCenter.model.ConfigOption;
import com.shcem.configCenter.model.DefaultOptions;
import com.shcem.configCenter.service.ConfigCenterService;
import com.shcem.configCenter.service.impl.ConfigCenterServiceImpl;
import com.shcem.configCenter.utils.ZKUtil;
...
public class ConfigCenterFactory {
    ...
    private String getDefaultZkurl() {
        ...
        if (StringUtils.isEmpty(this.defaultZkurl)) {
            throw new RuntimeException("can not get zk url,you must config it, file name:" );
        }
        return this.defaultZkurl;
    }
